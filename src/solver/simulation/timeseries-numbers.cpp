                                ...
                                Study& study)
{
    ...
    ts_to_numberOfTSretrievers[timeSeriesHydroEnergyCredits]
      = make_shared<hydroEneregyCreditsAreaNumberOfTSretriever>(study);
                                       ...
                                       Study& study)
{
    ...
    if (isTSintermodal[indexTS])
    {
        uint nbTimeSeries = isTSgenerated[indexTS] ? parameters.nbTimeSeriesHydroEnergyCredits
                                                   : area.hydro.series->countenergycredits;
        listNumberTsOverArea.push_back(nbTimeSeries);
    }
