...
namespace Antares
{
double HydroManagement::GammaVariable(double r) // nothing to change here
{
    double x = 0.;
    do
    {
...
inline double HydroManagement::BetaVariable(double a, double b) // nothing to change here
{
...
HydroManagement::HydroManagement(Data::Study& study) : study(study), parameters(study.parameters) // created pAreasCluster
{
...
HydroManagement::~HydroManagement() // created pAreasCluster
{
    for (uint numSpace = 0; numSpace < study.maxNbYearsInParallel; numSpace++)
