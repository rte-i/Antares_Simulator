...
void setBoundsOnENS(PROBLEME_HEBDO* ProblemeHebdo, HOURLY_CSR_PROBLEM& hourlyCsrProblem)
{
    ...
    for (int area = 0; area < ProblemeHebdo->NombreDePays; ++area)
    {
            ...
            == Data::AdequacyPatch::physicalAreaInsideAdqPatch)
        {
            ...
            ProblemeAResoudre->Xmax[Var] = hourlyCsrProblem.densNewValues[area] + 1e-3; //LINFINI_ANTARES;
            ProblemeAResoudre->X[Var] = ProblemeHebdo->ResultatsHoraires[area]->ValeursHorairesDeDefaillancePositive[hour];
            AdresseDuResultat = &(
...
void setBoundsOnSpilledEnergy(PROBLEME_HEBDO* ProblemeHebdo, HOURLY_CSR_PROBLEM& hourlyCsrProblem)
{
    ...
    for (int area = 0; area < ProblemeHebdo->NombreDePays; ++area)
    {
            ...
            == Data::AdequacyPatch::physicalAreaInsideAdqPatch)
        {
            ...
            ProblemeAResoudre->X[Var] = ProblemeHebdo->ResultatsHoraires[area]->ValeursHorairesDeDefaillanceNegative[hour];
            AdresseDuResultat = &(
