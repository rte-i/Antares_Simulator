...
struct VCardReservoirLevel
{
    ...
    typedef VCardReservoirLevel VCardForSpatialAggregate;
...
class ReservoirLevel : public Variable::IVariable<ReservoirLevel<NextT>, NextT, VCardReservoirLevel>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardReservoirLevel VCardType;
    //! Ancestor
    typedef Variable::IVariable<ReservoirLevel<NextT>, NextT, VCardType> AncestorType;
...
public:
    ...
    void hourForEachArea(State& state, unsigned int numSpace)  // TODO Milos: adjust results for hydro clusters
    {
        ...
        pValuesForTheCurrentYear[numSpace].hour[state.hourInTheYear]
          = state.hourlyResults->niveauxHoraires[state.hourInTheWeek];
...
#endif // __SOLVER_VARIABLE_ECONOMY_ReservoirLevel_H__
