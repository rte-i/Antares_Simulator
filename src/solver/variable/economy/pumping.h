...
struct VCardPumping
{
    ...
    typedef VCardPumping VCardForSpatialAggregate;
...
class Pumping : public Variable::IVariable<Pumping<NextT>, NextT, VCardPumping>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardPumping VCardType;
    //! Ancestor
    typedef Variable::IVariable<Pumping<NextT>, NextT, VCardType> AncestorType;
...
#endif // __SOLVER_VARIABLE_ECONOMY_Pumping_H__
