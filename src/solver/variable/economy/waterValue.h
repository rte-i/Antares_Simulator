...
struct VCardWaterValue
{
    ...
    typedef VCardWaterValue VCardForSpatialAggregate;
...
class WaterValue : public Variable::IVariable<WaterValue<NextT>, NextT, VCardWaterValue>
{
public:
    //! Type of the next static variable
    typedef NextT NextType;
    //! VCard
    typedef VCardWaterValue VCardType;
    //! Ancestor
    typedef Variable::IVariable<WaterValue<NextT>, NextT, VCardType> AncestorType;
